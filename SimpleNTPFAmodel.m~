classdef SimpleNTPFAmodel < ReservoirModel
    properties
    ...
    methods 
        function model = SimpleNTPFAmodel(G,rock,fluid,varargin)
            ...
            model.water = true;
            [L_ij1,L_ij2,L_ji1,L_ji2,A_ij,A_ji,pos_ij,pos_ji,intFace] = ntpfa(G,rock);
            model.operators.L_ij1 = L_ij1;
            model.operators.L_ij2 = L_ij2;
            model.operators.L_ji1 = L_ji1;
            model.operators.L_ji2 = L_ji2;
            model.operators.A_ij = A_ij;
            model.operators.A_ji = A_ji;
            model.operators.pos_ij = pos_ij;
            model.operators.pos_ji = pos_ji;
            model.operators.intFace = intFace;
